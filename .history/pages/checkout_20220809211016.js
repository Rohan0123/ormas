  ...
  return (<>
    ...
    <div class='flex ml-2'>
      ...
      <div  class="sideCart  font-black text-black bg-orange-200 py-10 px-5 w-full mb-5 rounded">        
        ...
        <button type='submit' onC class="flex my-5 text-orange-200 bg-black border-0 py-2 px-8 focus:outline-none  rounded-lg font-semibold " id={styles.checkout_button}>Pay ₹{subTotal}</button>
