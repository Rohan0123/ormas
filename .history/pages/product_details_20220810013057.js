              ...
              <div class="lg:w-1/2 lg:pl-10 lg:py-6 mt-6 lg:mt-0 " >
                ...
                <div class="flex mb-4">
                  <span class="flex items-center">
                    <svg fill="currentColor" stroke="currentColor" strokeLinecap="round"   strokeWidth="2" class="w-4 h-4 text-yellow-400" viewBox="0 0 24 24">
                    ...
                    <svg fill="none" stroke="currentColor" strokeLinecap="round"   strokeWidth="2" class="w-4 h-4 text-yellow-400" viewBox="0 0 24 24">
                      <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                    </svg>
                  ...
                  <span class="flex ml-3 pl-3 py-2 border-l-2 border-gray-800 text-gray-500 space-x-2">
                    <a>
                      <svg fill="currentColor" strokeLinecap="round"   strokeWidth="2" class="w-5 h-5" viewBox="0 0 24 24">
                  ...
                  <div class="flex ml-6 items-center">
                    ...
                    <div class="relative">
                      ...
                      <span class="absolute right-0 top-0 h-full w-10 text-center text-gray-600 pointer-events-none flex items-center justify-center">
                        <svg fill="none" stroke="currentColor" strokeLinecap="round"   strokeWidth="2" class="w-4 h-4" viewBox="0 0 24 24">
                ...
                <div class="flex">
                  ...
                  <button onClick={()=>{addToCart(slug, 1, 120, "Lemon Grass Oil", "250ml","Oil")}} class='hover:cursor-pointer text-3xl mx-5'><AiOutlineShoppingCart /></button>
        ...
        <section class="text-gray-400 bg-black body-font my-5">
          <div class="container px-5 py-24 mx-auto">
            <div class="text-center mb-20">
              ...
              <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-400 text-opacity-80">Lemon Grass is the base of every India dish for ots rich colour and flavour. It also has known antiseptic and antibacterial properties.</p>
            ...
            <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
              <div class="p-4 md:w-1/3 flex flex-col text-center items-center">
                <div class="w-20 h-20 inline-flex items-center justify-center rounded-full bg-gray-800 text-yellow-400 mb-5 flex-shrink-0">
                  <svg fill="none" stroke="currentColor" strokeLinecap="round"   strokeWidth="2" class="w-10 h-10" viewBox="0 0 24 24">
