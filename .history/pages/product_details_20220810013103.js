        ...
        <section class="text-gray-400 bg-black body-font my-5">
          <div class="container px-5 py-24 mx-auto">
            <div class="text-center mb-20">
              ...
              <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-400 text-opacity-80">Lemon  is the base of every India dish for ots rich colour and flavour. It also has known antiseptic and antibacterial properties.</p>
