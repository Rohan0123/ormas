...
const map = () => {
  return (<>
    <h2 className='flex justify-center object-center font-serif font-bold text-2xl mt-2 '>Koraput District Map )</h2> 
    <div className="flex justify-center object-center" id={styles.map}>
