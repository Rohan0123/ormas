...
export default function Home() {
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-200 h-200" src="Workers.jpeg" alt="First slide"/>
    </div>
    <div class="carousel-item">
      <img class="d-block w-500" src="Workers.jpeg" alt="Second slide"/>
    </div>
    <div class="carousel-item">
      <img class="d-block w-500" src="Workers.jpeg" alt="Third slide"/>
    </div>
  </div>
