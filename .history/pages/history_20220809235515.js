...
const history = () => {
  return (
    <div id="history">
    <div class={styles.page_title}>
      <h2>Our Journey</h2>
    </div>

    <div id='Our Journey'>
    <section class="text-orange-200 bg-black body-font my-10" >
    <div class="container px-5 py-24 mx-auto flex flex-wrap ">
      <h2 class="sm:text-3xl text-2xl text-white font-medium title-font mb-2 md:w-2/5">Background</h2>
      <div class="md:w-3/5 md:pl-6">
        ...
        <div class="flex md:mt-4 mt-6">
          <a class="text-orange inline-flex items-center ml-4">Learn More
    ...
    <section class="text-gray-400 bg-black body-font my-10" >
    <div class="container px-5 py-24 mx-auto flex flex-wrap ">
      <h2 class="sm:text-3xl text-2xl text-white font-medium title-font mb-2 md:w-2/5">The Road Ahead</h2>
      <div class="md:w-3/5 md:pl-6">
