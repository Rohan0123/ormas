...
<script></script>
    ...
    <div class='flex ml-2'>
      ...
      <Link href={"./Payment"}>
        <button type='submit' class="flex my-5 text-orange-200 bg-black border-0 py-2 px-8 focus:outline-none  rounded-lg font-semibold " id={styles.checkout_button}>Pay ₹{subTotal}</button>
        </Link>
    </div>
    </>
  )
