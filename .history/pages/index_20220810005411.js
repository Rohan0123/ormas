...
export default function Home() {
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img id={} class="d-block w-100" src="Workers.jpeg" alt="First slide"/>
    </div>
    <div class="carousel-item">
      <img id={} class="d-block w-100" src="Workers.jpeg" alt="Second slide"/>
    </div>
    <div class="carousel-item">
      <img id={} class="d-block w-100" src="Workers.jpeg" alt="Third slide"/>
    </div>
  </div>
