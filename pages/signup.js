  ...
  return (
    <div>
      <ToastContainer
              ...
              pauseOnHover
            />
      <section class="h-full gradient-form bg-orange-100 mx-auto md:h-screen w-2/3">
                  ...
                  <div class="lg:w-full px-4 md:px-0">
                    <div class="md:p-12 md:mx-6">
                      ...
                      <form onSubmit={handleSubmit} method="POST">
                        <p class="mb-4 text-gray-300">Please create your account</p>
                        <div class="mb-4">
                        <h3 class=' text-orange-200 mb-1.5'>Name:</h3>
                          <input
                            value={name}
                        ...
                        <div class="mb-4">
                        <h3 class='text-orange-200 mb-1.5'>E-mail:</h3>
                          <input
                            value={email}
                            onChange={handleChange}
                            type="text"
                        ...
                        <div class="mb-4">
                        <h3 class='text-orange-200 mb-1.5'>Password:</h3>
                          <input
                            value={password}
                            onChange={handleChange}
                            type="password"
                        ...
                        <div class="mb-4">
                        <h3 class='text-orange-200 mb-1.5'>Re-type The Password:</h3>
                          <input
                          value={repassword}
                            onChange={handleChange}
                            type="password"
                            class="form-control block w-full px-3 py-1.5 text-base font-normal text-black bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                            id="repassword"
                            name='repassword'
                        ...
                        <div class="flex items-center justify-between pb-6">
                          <p class="mb-0 mr-2 text-orange-200">If you have an account?</p>
                          <Link href="./login">
                            <button
                              type="button"
