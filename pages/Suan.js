        ...
        <section class="text-gray-400 bg-black body-font overflow-hidden" id={styles.details}>
          <div class="container px-5 py-16 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
              <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded-xl" src="/Suan.jpeg" />
              <div class="lg:w-1/2 lg:pl-10 lg:py-6 mt-6 lg:mt-0 " >
                <h2 class="text-sm title-font text-gray-500 tracking-widest">ORMAS</h2>
                <h1 class="text-white text-3xl title-font font-medium mb-1">Suan</h1>
                <div class="flex mb-4">
                ...
                <div class="flex">
                  ...
                  <Link href={"./checkout"}>
                  <button onClick={()=>{addToCart(4, 1, 120, "Suan", "250ml","Oil")}}  class="flex ml-auto text-black bg-orange-200 border-0 py-2 px-6 focus:outline-none hover:bg-orange-100 rounded">Buy Now</button>
                  </Link>
                  <button onClick={()=>{addToCart(4, 1, 120, "Suan", "250ml","Oil")}} className='hover:cursor-pointer hover:text-orange-200 text-3xl mx-5'><AiOutlineShoppingCart /></button>
        ...
        <section class="text-gray-400 bg-black body-font my-5">
          <div class="container px-5 py-24 mx-auto">
            <div class="text-center mb-20">
              ...
              <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-400 text-opacity-80">Suan is the base of every India dish for ots rich colour and flavour. It also has known antiseptic and antibacterial properties.</p>
            ...
            <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
              <div class="p-4 md:w-1/3 flex flex-col text-center items-center">
                ...
                <div class="flex-grow">
                  ...
                  <p class="leading-relaxed text-base">Suan is the base of every India dish for ots rich colour and flavour. It also has known antiseptic and antibacterial properties.</p>
