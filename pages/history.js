          ...
          <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
            ...
            <div className="carousel-inner">
              <div className="carousel-item active">
                <img id={styles.slider_image} className="d-block w-100" src="Workers1.jpeg" alt="First slide" />
              </div>
              <div className="carousel-item">
                <img id={styles.slider_image} className="d-block w-100" src="Workers2.jpeg" alt="Second slide" />
              </div>
              <div className="carousel-item">
                <img id={styles.slider_image} className="d-block w-100" src="Workers3.jpeg" alt="Third slide" />
              </div>
              <div className="carousel-item">
                <img id={styles.slider_image} className="d-block w-100" src="Workers4.jpeg" alt="Third slide" />
              </div>
              <div className="carousel-item">
                <img id={styles.slider_image} className="d-block w-100" src="Workers5.jpeg" alt="Third slide" />
              </div>
              <div className="carousel-item">
                <img id={styles.slider_image} className="d-block w-100" src="Workers6.jpeg" alt="Third slide" />
              </div>
