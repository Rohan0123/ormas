...
const map = () => {
  return (<>
    <h2 class='flex justify-center object-center font-serif font-bold text-2xl mt-2 '>( Koraput District Map )</h2> 
    <div class="flex justify-center object-center" id={styles.map}>
